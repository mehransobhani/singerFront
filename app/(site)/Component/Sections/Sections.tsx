            ...
            <ul className="flex-column space-y space-y-4 text-sm font-medium text-gray-500   md:me-4 mb-4 md:mb-0">
                <li>
                    <div
                        ...
                        className={[selectedSession=="example"?"text-white bg-rose-500 ":"bg-gray-50 ","inline-flex items-center px-4 py-3  rounded-lg active w-full "].join(" ")}
                       aria-current="page">
                        <svg className="w-4 h-4 me-2 text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                ...
                <li>
                    <div
                        ...
                        className={[selectedSession=="team"?"text-white bg-rose-500 ":"bg-gray-50 ","inline-flex items-center px-4 py-3  rounded-lg active w-full "].join(" ")}
                    >
                        <svg className="w-4 h-4 me-2 text-gray-500  " aria-hidden="true"
                ...
                <li>
                    <div
                        ...
                        className={[selectedSession=="actions"?"text-white bg-rose-500 ":"bg-gray-50 ","inline-flex items-center px-4 py-3  rounded-lg active w-full "].join(" ")}
                    >
                        <svg className="w-4 h-4 me-2 text-gray-500  " aria-hidden="true"
                ...
                <li>
                    <div
                        ...
                        className={[selectedSession=="comment"?"text-white bg-rose-500 ":"bg-gray-50 ","inline-flex items-center px-4 py-3  rounded-lg active w-full "].join(" ")}
                    >
                        <svg className="w-4 h-4 me-2 text-gray-500  " aria-hidden="true"
                             xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                            <path
